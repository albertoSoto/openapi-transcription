...
public class OpenAIClientApplicationTests {
...
//       ChatRequest chatRequest = ChatGPTRequest
//               .builder()
//               .set("what is your name?")
//               .build();
       ChatRequest chatRequest = new ChatRequest();
       chatRequest.setQuestion("what is your name?");
       ...
       chatGPTResponse.setModel("model");
       chatGPTResponse.setObject("My name is Siri");
...
//               .build();
       ...
       Assertions.assertEquals("My name is Siri", cgr.getObject());
   }
